    ...
    <div className="min-h-screen">
      ...
      <section className="relative bg-[rgb(58,88,129)] pt-20 pb-14 overflow-hidden">
        ...
        <Reveal animation="fade-up" className="relative z-10 max-w-4xl mx-auto px-6 text-center">
          ...
          <p className="text-sm text-white max-w-2xl mx-auto leading-relaxed">From consultation to commissioning — our streamlined process ensures the perfect solution for your energy needs.</p>
        </Reveal>
      </section>
            ...
            {steps.map((step, idx) => (
              <RevealItem key={step.title} animation="fade-up" className="relative group bg-white rounded-2xl border border-border p-6 hover:border-accent/30 hover:shadow-lg hover:-translate-y-1 transition-all duration-300 overflow-hidden">
                ...
                <div className="relative z-10">
                  ...
                  <h3 className="text-sm font-bold mb-2 text-text-primary group-hover:text-accent transition-colors">{step.title}</h3>
          ...
          <div className="space-y-10">
            <Reveal animation="fade-right" duration={800}>
              <div className="bg-white rounded-2xl p-8 shadow-[0_8px_30px_rgba(0,0,0,0.06)] flex flex-col md:flex-row gap-8 items-center">
                <div className="md:w-2/5 shrink-0">
                  <h3 className="text-lg font-bold text-text-primary mb-3 tracking-tight">Commercial & Industrial BESS</h3>
            ...
            <Reveal animation="fade-left" duration={800}>
              <div className="bg-white rounded-2xl p-8 shadow-[0_8px_30px_rgba(0,0,0,0.06)] flex flex-col md:flex-row-reverse gap-8 items-center">
                <div className="md:w-2/5 shrink-0">
                  <h3 className="text-lg font-bold text-text-primary mb-3 tracking-tight">Solar Integration</h3>
            ...
            <Reveal animation="fade-right" duration={800}>
              <div className="bg-white rounded-2xl p-8 shadow-[0_8px_30px_rgba(0,0,0,0.06)] flex flex-col md:flex-row gap-8 items-center">
                <div className="md:w-2/5 shrink-0">
                  <h3 className="text-lg font-bold text-text-primary mb-3 tracking-tight">EV Charging Systems</h3>
      ...
      <Reveal as="section" animation="zoom-in" className="relative py-20 bg-[rgb(58,88,129)] overflow-hidden">
        ...
        <div className="relative z-10 max-w-2xl mx-auto px-6 text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Link href="/contact" className="btn-pill btn-unity">Begin Consultation <ArrowRight className="w-4 h-4" /></Link>
            <Link href="/products" className="btn-pill bg-transparent text-white border border-white/15 hover:text-white hover:border-white transition-all">Explore Products First</Link>
          </div>
        </div>
      </Reveal>
    </div>
