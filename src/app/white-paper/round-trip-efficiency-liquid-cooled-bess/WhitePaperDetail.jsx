    ...
    try {
      ...
      const response = await fetch(`${apiUrl}leads/website-lead/`, {
        ...
        body: JSON.stringify({
          ...
          email,
          company,
          message: 'White Paper Download: Round-Trip Efficiency of Liquid-Cooled BESS',
      ...
      <section className="bg-white pt-32 pb-12 border-b border-gray-100">
        <div className="max-w-4xl mx-auto px-6">
          ...
          <h1 className="text-3xl md:text-4xl font-extrabold text-gray-900 leading-tight">
            White Paper: Round-Trip Efficiency of Liquid-Cooled Battery Energy Storage System
          </h1>

          <p className="text-gray-400 text-sm mt-4">By <span className="text-[rgb(58,88,129)] font-semibold">UnityESS</span></p>

          <p className="text-lg text-gray-600 mt-6 leading-relaxed max-w-3xl">
            A practical framework for measuring real-world efficiency in next-generation battery energy storage system.
          </p>
          ...
          <div className="flex justify-center">
            <div className="relative w-64 h-80 bg-gray-800 rounded-2xl shadow-2xl p-3">
              <div className="w-full h-full rounded-xl overflow-hidden bg-white">
                <img
                  src="/products/unity-model-c-system.webp"
                ...
                <div className="absolute inset-3 rounded-xl bg-linear-to-t from-black/60 via-transparent to-transparent flex flex-col justify-end p-4">
                  <p className="text-white text-xs font-bold leading-snug">Round-Trip Efficiency of Liquid-Cooled BESS</p>
