...
const socialLinks = [
  {
    name: 'LinkedIn',
    href: 'https://www.linkedin.com/company/ornate-solar/',
    icon: (
  ...
  {
    name: 'YouTube',
    href: 'https://www.youtube.com/channel/UCllwEDRGN9IvW8LOwfq0F-w',
    icon: (
      <svg viewBox="0 0 24 24" fill="currentColor" className="w-4 h-4">
  ...
  {
    name: 'Instagram',
    href: 'https://www.instagram.com/ornate_solar',
    icon: (
      <svg viewBox="0 0 24 24" fill="currentColor" className="w-4 h-4">
  ...
  {
    name: 'Facebook',
    href: 'https://www.facebook.com/ornatesolar/',
    icon: (
      <svg viewBox="0 0 24 24" fill="currentColor" className="w-4 h-4">
  ...
  {
    name: 'X',
    href: 'https://twitter.com/OrnateSolar',
    icon: (
      <svg viewBox="0 0 24 24" fill="currentColor" className="w-4 h-4">
  ...
  {
    name: 'WhatsApp',
    href: 'https://whatsapp.com/channel/0029VaAXgIm8vd1Y4THiKN3X',
    icon: (
      <svg viewBox="0 0 24 24" fill="currentColor" className="w-4 h-4">
      ...
      <div className="max-w-7xl mx-auto px-6">
          ...
          <div className="lg:col-span-2">
            ...
            <div className="flex gap-3">
              {socialLinks.map(({ name, href, icon }) => (
                <a key={name} href={href} target="_blank" rel="noopener noreferrer" aria-label={name} className="w-9 h-9 rounded-lg bg-bg-deep border border-border flex items-center justify-center text-text-secondary hover:border-accent hover:text-accent transition-all">
                  {icon}
                </a>
              ))}
            </div>
        ...
        <div className="pt-6 border-t border-border flex flex-col md:flex-row justify-between items-center gap-4">
          ...
          <div className="flex gap-6">
            <Link href="/privacy-policy" className="text-xs text-text-tertiary hover:text-text-primary transition-colors">Privacy Policy</Link>
