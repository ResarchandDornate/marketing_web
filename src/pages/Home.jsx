      ...
      <section className="relative w-full overflow-hidden pt-28 pb-14 bg-[#020B18]">
        ...
        <div className="relative z-10 max-w-6xl mx-auto px-6 w-full">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 items-center">
            ...
            <div className="relative flex items-end justify-center -space-x-8 sm:-space-x-12 animate-fadeIn">
        ...
        <div className="max-w-5xl mx-auto px-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-5">
            {[
              ...
              <div key={item.title} className="group bg-[#f8f9fa] rounded-xl p-5 border border-black/5 hover:shadow-md hover:-translate-y-0.5 transition-all duration-300">
