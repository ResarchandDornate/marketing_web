      ...
      <Reveal as="section" animation="zoom-in" className="py-16 bg-white text-center relative overflow-hidden">
        ...
        <div className="max-w-3xl mx-auto px-6 relative z-10">
          ...
          <div className="flex flex-col sm:flex-row justify-center gap-3">
            <Link to="/contact" className="btn-corporate bg-brand-blue-dark text-white text-sm py-3! px-8! shadow-[0_10px_30px_rgba(0,184,83,0.2)]  hover:-translate-y-1 transition-all">
              Contact Engineering
            </Link>
      ...
      <div className="max-w-7xl mx-auto px-6 relative z-10">
        ...
        <Reveal animation="fade-up">
          <div className="flex flex-col sm:flex-row sm:items-end sm:justify-between gap-3 mb-6">
            ...
            <Link to="/products" className="text-[10px] font-bold text-white border border-white rounded-full px-4 py-2 hover:text-white hover:border-white/25 transition-all whitespace-nowrap self-start sm:self-auto">
