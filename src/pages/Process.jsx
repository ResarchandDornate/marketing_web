      ...
      <Reveal as="section" animation="zoom-in" className="relative py-20 bg-[rgb(58,88,129)] overflow-hidden">
        ...
        <div className="relative z-10 max-w-2xl mx-auto px-6 text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            ...
            <Link to="/products" className="btn-pill bg-transparent text-white border border-white/15 hover:text-white hover:border-white transition-all">Explore Products First</Link>
          </div>
        </div>
      </Reveal>
    </div>
